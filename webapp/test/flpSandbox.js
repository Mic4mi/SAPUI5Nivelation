		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#accemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accemployees-display": {
								"semanticObject": "accemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.employees",
									"url": sap.ui.require.toUrl("acc/employees")
								}
							}
						}
					}
